...
local temenos_floor_positions = {
    --{key = 'Temenos:Entrance', display = 'Temenos Entrance', x = 580.0, y = 86.000007629395, z = 0.0},
...
local apollyon_floor_positions = {
    --{key = 'Apollyon:E1', display = 'Apollyon Entrance 1', x = -608.0, y = -600.0, z = 0.0},
    --{key = 'Apollyon:E2', display = 'Apollyon Entrance 2', x = 608.0, y = -600.0, z = 0.0},
